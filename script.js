...
const EMERGENCY_BACKUP_KEY =
    "assignmentCalendarEmergencyBackup";
    ...
    try {
        ...
        if (emergency) {
            ...
            if (
                ...
                console.warn(
                    "Recovered assignments from emergency backup."
                );
        ...
        console.error(
            "Emergency assignment recovery failed:",
            error
        );
...
async function loadCloudData() {
    ...
    try {
        ...
        //
        // NEVER allow an empty cloud record to erase
        ...
        if (
            ...
            // ------------------------------------------------
            // CASE 2:
            // CLOUD EMPTY BUT LOCAL HAS DATA
            //
            // KEEP LOCAL DATA.
            // PUSH IT TO CLOUD.
            // ------------------------------------------------
                ...
                console.warn(
                    "Cloud was empty. Keeping local assignments instead of erasing them."
                );
        ...
        // ----------------------------------------------------
            ...
            // DO NOT replace it with empty cloud data.
        ...
        // IMPORTANT:
        // Even if cloud fails, always show local data.
...
// Supabase is started AFTERWARD.
//
// This means a cloud problem can NEVER prevent
// the calendar itself from appearing.
// ============================================================
...
// Only after the entire planner has rendered:
...
let generalTodos = loadGeneralTodos();
...
async function initializeCloud() {
    ...
    if (
        ...
        SUPABASE_KEY.includes("PASTE YOUR")
    ) {

        showCloudStatus("Local mode");
...
function createLoginUI() {
    ...
    document
        .getElementById("cloudLoginButton")
        .addEventListener(
            "click",
            loginToCloud
        );
...
function showCalendar() {
    ...
    for (
        ...
        // ----------------------------------------------------
        // IMPORTANT:
        // THE DAY BOX CAN GROW AS TALL AS NECESSARY.
        // ----------------------------------------------------

        dayBox.style.minHeight =
            "300px";

        dayBox.style.height =
            "auto";

        dayBox.style.overflow =
            "visible";
        ...
        dayAssignments.forEach(
            assignment => {
                ...
                // ONE LINE ONLY.
                //
                // The assignment itself stays 24px tall.
                // The DAY BOX is still allowed to grow.
                // =================================================
...
function renderTodoList() {
    ...
    todoItems.style.maxHeight =
        "312px";


    todoItems.style.overflowY =
        "auto";


    todoItems.style.overflowX =
        "hidden";
